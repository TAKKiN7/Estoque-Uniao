...
class Entrada(CTkToplevel):
    ...
    def confirmar(self, produto : str, modelo: str, quantidade : int, e=None):
        ...
        quantidade_atual = item.get("quantidade")
        ...
        values : tuple = (produto, modelo, quantidade_nova, self.codigo)
